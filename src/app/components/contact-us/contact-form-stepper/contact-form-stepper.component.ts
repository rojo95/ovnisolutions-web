...
export class FormStepperComponent implements OnInit {
  ...
  subServices:any = [
    {
      id: 1,
      service_id: 1,
      desc: 'Sitio web básico (one page)',
    },
    {
      id: 2,
      service_id: 1,
      desc: 'Sitio web empresarial (hasta 5 secciones)',
    },
    {
      id: 3,
      service_id: 1,
    ...
    },
    {
      id: 4,
      service_id: 1,
      desc: 'Tienda virtual (E-commerce​)',
    },
    {
      id: 5,
      service_id: 1,
      desc: 'Apps telefónicas (Android)',
    },
    {
      id: 6,
      service_id: 1,
      desc: 'Desarrollo de APIs (Interfaz de Programación de Aplicaciones)',
    },
    {
      id: 7,
      service_id: 2,
    ...
    },
    {
      id: 8,
      service_id: 2,
      desc: 'Diseño de Packaging',
    },
    {
      id: 9,
      service_id: 2,
      desc: 'Diseño publicitario',
    },
    {
      id: 10,
      service_id: 2,
    ...
    },
    {
      id: 12,
      service_id: 3,
      desc: 'Gestión de Páginas Web',
    },
    {
      id: 13,
      service_id: 3,
      desc: 'Alojamiento de Sitio Web',
    },
  ...
  ngOnInit(): void {
    ...
    this.countries_showed = this.countries;
    // this.showedSubService = this.subService;
  }

  capitalizeTxt(input:any) {
    let txt = input.value.replace(/\w\S*/g, function(txt:any){
  ...
  filterType(string:string) {
    this.client_types = this.ct.filter((type:any) => (type.name.toLowerCase().normalize('NFD').replace(/\p{Diacritic}/gu, "").indexOf(string.toLowerCase().normalize('NFD').replace(/\p{Diacritic}/gu, "")) > -1));
  }

  filterCountry(string:string) {
    this.countries_showed = this.countries.filter((country:any) => (country.name_es.toLowerCase().normalize('NFD').replace(/\p{Diacritic}/gu, "").indexOf(string.toLowerCase().normalize('NFD').replace(/\p{Diacritic}/gu, "")) > -1));
  }
  ...
  sendMessage(){
    ...
    const data = {
      ...
      client_type: this.firstForm.get('client_type')?.value,
      country: this.firstForm.get('country')?.value,
      service: this.secondForm.get("service")?.value,
      subservice: this.secondForm.get("subService")?.value,
